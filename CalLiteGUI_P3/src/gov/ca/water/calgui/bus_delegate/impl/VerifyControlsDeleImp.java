...
public class VerifyControlsDeleImp implements IVerifyControlsDele {
	...
	private void verifyGUIToSeedData() {
		...
		removeList.addAll(Arrays.asList("fac_ckb1", "fac_ckb4", "fac_ckb5", "fac_ckb8", "fac_ckb7", "fac_ckb9", "fac_ckb6",
		        "fac_ckb30", "fac_ckb31", "fac_ckb32", "fac_ckb33", "fac_ckb38", "fac_ckb20", "fac_ckb21", "fac_ckb22", "fac_ckb23",
		        "fac_ckb24", "fac_ckb25", "fac_ckb26", "fac_ckb27", "fac_ckb28", "fac_ckb29", "fac_ckb10", "fac_ckb13", "fac_ckb14",
		        "fac_ckb15", "fac_ckb16", "fac_ckb17", "fac_ckb18", "fac_ckb19", "fac_ckb42", "fac_ckb43", "fac_ckb45",
		        "Vern_RPA"));
		...
		getTheIds(xmlParsingSvc.getSwingEngine().find("externalPDF"), removeList);
	...
	/**
	 * This method will verify the Gui id with the cls file id's. In this we only check the controls from the cls file.
	 *
	 * @param fileName
	...
	private void verifyCLSToGUIIds(String fileName) {
		...
		List<String> tempList = Arrays.asList("run_txfDir", "hyd_ANNKM", "hyd_DSS_Index", "fac_ckb1", "fac_ckb4", "fac_ckb5",
		        ...
		        "op_ckbSWP", "op_ntfSWP", "op_ckbCWP", "op_ntfCWP1", "op_ntfCWP2", "txf_Manual_SV", "txf_Manual_SV_F",
		        "txf_Manual_Init", "txf_Manual_Init_F");
		...
		List<String> regData = new ArrayList<String>(Arrays.asList(regulationoptionsStr.get(0).split(Constant.PIPELINE_DELIMITER)));
